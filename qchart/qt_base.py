"""
This module exists to smooth out some of the differences between PySide2 and PyQt5:

* Automatically import either PyQt5 or PySide2 depending on availability
...
if QT_LIB is None:
    raise Exception("qchart requires one of PyQt5 or PySide2; none of these packages could be imported.")
...
if m is not None and list(map(int, m.groups())) < versionReq:
    ...
    raise Exception('qchart requires Qt version >= %d.%d  (your version is %s)' % (versionReq[0], versionReq[1], QtVersion))
